...
class SignalementFactory extends Factory
{
    public function definition(): array
    {
        ...
        if ($statut !== 'En attente') {
            $adminId = Admin::inRandomOrder()->value('idUtilisateur');
        }
        ...
        return [
            ...
            'id_Utilisateur_Admin' => $adminId,

            'id_Offre_De_Stage' =>
                Offredestage::inRandomOrder()->value('id')
                ?? Offredestage::factory(),
        ];
    }
}