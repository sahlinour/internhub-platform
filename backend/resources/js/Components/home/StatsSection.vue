...
<template>
    <section class="bg-white font-body py-8">
        <div class="max-w-6xl mx-auto px-6">
            <div
                ...
                style="
                    ...
                    box-shadow: 0 8px 30px rgba(22,66,91,0.07);
                "
            >
                <div
                    v-for="(stat, i) in stats"
                    :key="i"
                    class="flex flex-col items-center justify-center py-10 px-6 transition-all duration-300"
                    style="background: white;"
                    @mouseenter="$event.currentTarget.style.background='#F0F7FB'"
                    @mouseleave="$event.currentTarget.style.background='white'"
                >
                    <p
                        class="text-3xl font-bold mb-1 tabular-nums"
                        style="
                    ...
                    <div
                        class="w-8 h-px my-3"
                        style="background: rgba(129,195,215,0.5);"
                    ></div>

                    <p
                        class="text-xs font-semibold tracking-widest uppercase text-center"
                        style="color: #3A7CA5;"
                    >
                        {{ stat.label }}
                    </p>
