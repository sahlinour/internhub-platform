    ...
    <section class="bg-white font-body py-24">
        <div class="max-w-7xl mx-auto px-8">
            <div class="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 gap-4">
                ...
                <Link to="/login" class="flex items-center gap-2 text-sm font-semibold px-5 py-2.5 rounded-xl transition-all duration-200 hover:-translate-y-0.5"
            ...
            <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="flex justify-between items-center mb-4">
                 ...
                 <Link to="/login" class="block text-center py-2.5 rounded-xl text-sm font-semibold transition-all duration-200"
