...
const initials = () => {
    if (!admin?.nom_complet) {
        return 'A'
    }

    return admin.nom_complet
        .split(' ')
        .map((word) => word[0])
        .join('')
        .slice(0, 2)
        ...
        <div class="min-h-0">
            ...
            >
                ...
                <div class="min-w-0">
                    ...
                    >
                        {{ admin?.nom_complet ?? 'Administrator' }}
                    </strong>
